...
export const StaggeredMenu = ({
  ...
  return (
    <div
      ...
      <style>{`
.sm-scope .staggered-menu-wrapper {position: fixed;top: 0;right: 0;width: 100%;height: 100dvh;z-index: 98;pointer-events: none;}
.sm-scope .staggered-menu-header { pointer-events: auto; position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 2em; background: transparent; pointer-events: none; z-index: 20; }
...
.sm-scope .sm-line-olds { display: none !important; }
.sm-scope .staggered-menu-panel { pointer-events: auto; poimport StaggeredMenu from '../../../ts-default/Components/StaggeredMenu/StaggeredMenu';
